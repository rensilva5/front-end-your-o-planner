...
export default function Hero() {
  return (
    ...
    <div>
      ...
      <p>A peninsula is a piece of land surrounded by water on three sides. Europe is a home to majestic mountain ranges, captivating  coastlines, and idyllic islands as well as the Mediterranean, Black, and Caspian seas to the south; moreover, Europe boasts some of the most spectacular scenery on Earth.</p> 
      ...
      <p>The outstanding growth industry of tourism—supplementing business, professional, and student travel—brings employment and foreign exchange to many Europeans.</p> 

      <p>The variety of languages and cultures make Europe even a more exotic Continent.</p>
      </div>
